    ...
    return (
        <div className='  bg-gradient-to-t from-gray-500 to-[#F6E0BE] h-screen border-r '>
            ...
            <div className="flex justify-center">
                <img className=' w-52 mt-10' src="https://cdn.dribbble.com/users/9279718/screenshots/17292901/media/c3acd1b391ef91a6a4f87b8562c52413.png?resize=1000x750&vertical=center" alt="" />
